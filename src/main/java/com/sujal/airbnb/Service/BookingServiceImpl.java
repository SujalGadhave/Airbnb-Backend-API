...
import com.sujal.airbnb.Entities.*;
...
import com.sujal.airbnb.Repository.*;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDTO initialiseBooking(BookingRequest bookingRequest) {
        ...
        if (inventoryList.size() != daysCount){
            throw new RuntimeException("Room is not available anymore");
        }
    ...
    public void capturePayment(Event event) {
        if ("checkout.session.completed".equals(event.getType())){
            ...
            BookingEntity booking = bookingRepository.findByPaymentSessionId(sessionId).orElseThrow(() ->
